...
public class ClockWidget5x4 extends AppWidgetProvider {
	
	public ClockWidget5x4() {
		super();
	}
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (AppWidgetManager.ACTION_APPWIDGET_DELETED.equals(action)) {
			...
			// Set time for output
	        OMCWidgetDrawEngine.updateAppWidget(context, OMC.WIDGET5x4CNAME);
	...
	public void onUpdate(Context context, AppWidgetManager aWM, int[] appWidgetIds) {
        ...
        for (int i=0; i<N; i++) {
        		...
        		// Redraw the widget.
                OMCWidgetDrawEngine.updateAppWidget(context, aWM, appWidgetIds[i], OMC.WIDGET5x4CNAME);
        }
